    ...
    if(webStorage.get('login') == 'false'){
        ...
        $scope.doSignUp = function (signup) {
            if(CheckInput(signup.serialNumber) && CheckInput(signup.email)
                ...
                toaster.pop('success', "Registering device!", "Please wait, while we are registering your device!");
            }
            else
